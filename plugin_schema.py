...
MODEL_FIELD_TEMPLATE: Dict[str, Any] = {
    ...
    "seed_enabled": {
        ...
        "order": 8.5,
        "label": "启用随机种子",
        "description": "是否向API发送seed参数。关闭后由服务端随机生成",
    },
    "guidance_scale": {
        "type": float,
        "default": 5,
    ...
    "guidance_scale_enabled": {
        "type": bool,
        "default": True,
        "group": "params",
        "order": 9.5,
        "label": "启用引导强度",
        "description": "是否向API发送guidance_scale(CFG)参数。关闭后由服务端默认处理",
    },
    "num_inference_steps": {
        "type": int,
        "default": 28,
    ...
    "num_inference_steps_enabled": {
        "type": bool,
        "default": True,
        "group": "params",
        "order": 10.5,
        "label": "启用推理步数",
        "description": "是否向API发送num_inference_steps参数。关闭后由服务端默认处理",
    },
    "watermark": {
        "type": bool,
        "default": False,
    ...
    "img2img_format": {
        "type": str,
        "default": "auto",
        "choices": ["auto", "edits-images", "edits-file"],
        "group": "params",
        "order": 15.1,
        "label": "图生图格式",
        "description": "图生图请求格式。auto=自动降级适配；edits-images=JSON images数组；edits-file=multipart文件上传",
    },
    "auto_recall_delay": {
        "type": int,
        "default": 0,
